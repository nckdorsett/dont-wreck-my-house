...
public class Host {
    ...
    public Host(String id, String lastName, String email, String phoneNumber, String address, String city, String state, int postalCode, BigDecimal stdRate, BigDecimal wkndRate) {
        this.id = id;
